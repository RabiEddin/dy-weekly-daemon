...
<div class="masthead"><div class="mast-title">THE WEEKLY DAEMON</div><div class="mast-meta"><span>Vol.8 2026.4/30 – 5/7</span><span>WEEKLY TECH &amp; AI DIGEST</span><span>33 Articles This Week</span></div></div>
...
<!-- badge:1 -->
![Claude — 금융 실무용 AI 에이전트 템플릿 공개](images/12.jpg)
...
<div class="badges"><img src="../assets/badges/claude-pick.png" class="badge" alt="Claude's Pick"> <img src="../assets/badges/claude-pick.png" class="badge" alt="Claude's Pick"></div>

![Google Agent Skills: AI 에이전트용 공식 스킬 저장소 오픈](images/31.jpg)
...
<!-- badge:3 -->
![RLEnvs101: LLM 강화학습 프레임워크 실전 비교 가이드](images/03.jpg)
...
<!-- badge:5 -->
![SubQ — 12M 토큰 LLM의 화려한 주장과 벤치마크 의혹](images/06.jpg)
...
![Recursive Multi-Agent Systems: 텍스트 없이 숨겨진 상태로 직접 통신하는 AI 에이전트](images/09.jpg)
...
<!-- badge:7 -->
![Gemma 4: 추론 속도 최대 3배 향상된 생성 AI 모델](images/10.jpg)
...
<!-- badge:8 -->
![Gemma 4: 다중 토큰 예측으로 추론 속도 3배 향상](images/11.jpg)
...
<!-- badge:9 -->
![Stanford CS336 기반 LLM 대학원 강의: 인하대 안남혁 교수 오픈소스 공개](images/18.jpg)
...
![SKILL-RAG: LLM 자기 지식으로 RAG 성능을 높이는 프레임워크](images/25.jpg)
...
<!-- badge:11 -->
![Waldo — AI 에이전트 속도를 10배 높인 소형 언어모델 기반 검색 전문화](images/26.jpg)
...
<!-- badge:12 -->
![희소 벡터 검색: 한국어 특화 파인튜닝으로 높인 정보 검색 성능](images/28.jpg)
...
<!-- badge:13 -->
![gc-tree — AI 코딩 에이전트를 위한 글로벌 컨텍스트 관리 도구](images/13.jpg)
...
![Lazyweb — AI 코드 생성의 디자인 품질 향상을 위한 무료 레퍼런스 툴](images/14.jpg)
...
<!-- badge:15 -->
![OpenScreen — 월 29달러 유료 화면 녹화 도구를 대체하는 무료 오픈소스](images/15.jpg)
...
<!-- badge:16 -->
![Claude Code — 개발자 용어를 한국어로 번역하는 AI 스킬](images/16.jpg)
...
<!-- badge:17 -->
![Claude Code — AWS 서버리스 개발을 위한 AI 플러그인 출시](images/17.jpg)
...
<!-- badge:18 -->
![Tolaria — LLM 위키 개념을 구현한 오프라인 마크다운 기반 지식 관리 도구](images/19.jpg)
...
<!-- badge:19 -->
![google-surf-mcp — API 키 없는 Google 검색 MCP 도구](images/20.jpg)
...
<!-- badge:20 -->
![Claude Code — 멀티 세션 동시 작업으로 개발 오케스트레이션 패러다임 전환](images/21.jpg)
...
<!-- badge:21 -->
![CocoIndex — 실시간 RAG 데이터 갱신 엔진](images/22.jpg)
...
<!-- badge:22 -->
![Claude API — 4개 개발 도구에 통합되며 SDK 사용성 개선](images/23.jpg)
...
![Quarkdown — 마크다운에 함수 기능을 더한 조판 언어](images/24.jpg)
...
<!-- badge:24 -->
![Onyx — 50개 사내 앱 연동하는 오픈소스 AI 검색 플랫폼](images/29.jpg)
...
<!-- badge:26 -->
![Claude Code — API 마이그레이션과 프롬프트 캐싱 자동화 스킬](images/32.jpg)
...
<!-- badge:29 -->
![Code with Claude — Anthropic의 개발자 컨퍼런스를 유튜브 미디어로 전환](images/04.jpg)
...
<!-- badge:30 -->
![Claude Managed Agents — AI 에이전트 자율 학습과 원클릭 배포 시대 개막](images/05.jpg)
...
<!-- badge:31 -->
![Google Gemini: 파일 생성 및 다운로드 기능 공식 출시](images/07.jpg)
...
<!-- badge:32 -->
![Claude — API 키 관리 없이 클라우드 IAM으로 인증](images/08.jpg)
...
![Refero Styles — AI 에이전트를 위한 2,000개 제품의 디자인 시스템](images/27.jpg)
